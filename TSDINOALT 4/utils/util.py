...
def init_distributed_mode(args):
    ...
    # we manually add MASTER_ADDR and MASTER_PORT to env variables
        ...
        sys.exit(1)
    backend = "nccl" if torch.cuda.is_available() and platform.system() != "Darwin" else "gloo"
...
class SmoothedValue(object):
    ...
    def synchronize_between_processes(self):
        ...
        t = torch.tensor([self.count, self.total], dtype=torch.float64, device=curr_device)
        dist.barrier()
        dist.all_reduce(t)
        t = t.tolist()
        self.count = int(t[0])
